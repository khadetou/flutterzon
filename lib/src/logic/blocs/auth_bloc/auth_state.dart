...
// textfield states
final class TextFieldChangeState extends AuthState {
  final String emailValue;
  final String passwordValue;

  TextFieldChangeState(this.emailValue, this.passwordValue);
  @override
...
final class CreateUserSuccessState extends AuthState {
  final String userCreateString;

  CreateUserSuccessState({required this.userCreateString});

  @override
  List<Object?> get props => [userCreateString];
}
